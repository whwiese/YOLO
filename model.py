...
class YOLOv1(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.architecture = yolov1_architecture 
...
class YOLOv2_lite(nn.Module):
    ...
    def __init__(self, num_classes, in_channels=3, grid_size=7, num_boxes=2):
        super().__init__()
        self.dn1 = yolov2_darknet_pt1
        self.dn2 = yolov2_darknet_pt2
        self.darknet_pt1 = self.create_darknet(self.dn1)
        self.darknet_pt2 = self.create_darknet(self.dn2, in_channels=512)
        self.last_conv= nn.Conv2d(1024, num_classes+(num_boxes*5), 1,  bias=False,
               stride=1, padding=0)
    ...
    def create_darknet(self, architecture, in_channels=3):
        layers = []
...
#def test_model(grid_size = 13, num_boxes=2, num_classes=20):
